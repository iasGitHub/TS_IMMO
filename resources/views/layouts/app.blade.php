    ...
    <header class="header black-bg">
      ...
      <div class="nav notify-row" id="top_menu">
        ...
        <ul class="nav top-menu">
          <!-- settings start -->
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="{{secure_asset('assets/index.html#')}}">
            ...
            <ul class="dropdown-menu extended tasks-bar">
              ...
              <li>
                <a href="{{secure_asset('assets/index.html#')}}">
                  <div class="task-info">
              ...
              <li class="external">
                <a href="{{secure_asset('assets/#')}}">See All Tasks</a>
              </li>
            </ul>
          </li>
          <!-- settings end -->
          ...
          <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="{{secure_asset('assets/index.html#')}}">
                  <span class="photo"><img alt="avatar" src="{{secure_asset('assets/img/ui-zac.jpg')}}"></span>
                  <span class="subject">
              ...
              <li>
                <a href="{{secure_asset('assets/index.html#')}}">
                  <span class="photo"><img alt="avatar" src="{{secure_asset('assets/img/ui-divya.jpg')}}"></span>
                  <span class="subject">
              ...
              <li>
                <a href="{{secure_asset('assets/index.html#')}}">
                  <span class="photo"><img alt="avatar" src="{{secure_asset('assets/img/ui-danro.jpg')}}"></span>
                  <span class="subject">
              ...
              <li>
                <a href="{{secure_asset('assets/index.html#')}}">
                  <span class="photo"><img alt="avatar" src="{{secure_asset('assets/img/ui-sherman.jpg')}}"></span>
                  <span class="subject">
              ...
              <li>
                <a href="{{secure_asset('assets/index.html#')}}">See all messages</a>
              </li>
            </ul>
          </li>
          <!-- inbox dropdown end -->
          ...
          <li id="header_notification_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended notification">
              ...
              <li>
                <a href="{{secure_asset('assets/index.html#')}}">See all notifications</a>
              </li>
            </ul>
          </li>
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <div class="credits">
          ...
          -->
          Created with Dashio template by <a href="{{secure_asset('assets/https://templatemag.com/')}}">TemplateMag</a>
        </div>
        <a href="{{secure_asset('assets/index.html#')}}" class="go-top">
