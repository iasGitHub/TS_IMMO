    ...
    <header class="header black-bg">
      ...
      <div class="nav notify-row" id="top_menu">
        ...
        <ul class="nav top-menu">
          <!-- settings start -->
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="{{asset('assets/index.html#')}}">
            ...
            <ul class="dropdown-menu extended tasks-bar">
              ...
              <li class="external">
                <a href="{{asset('assets/#')}}">See All Tasks</a>
              </li>
            </ul>
          </li>
          <!-- settings end -->
          ...
          <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="{{asset('assets/index.html#')}}">See all messages</a>
              </li>
            </ul>
          </li>
          <!-- inbox dropdown end -->
          ...
          <li id="header_notification_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended notification">
              ...
              <li>
                <a href="{{asset('assets/index.html#')}}">See all notifications</a>
              </li>
            </ul>
          </li>
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="{{asset('assets/login.html')}}">Logout</a></li>
        </ul>
      </div>
    </header>
    <!--header end-->
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <div class="credits">
          ...
          -->
          Created with Dashio template by <a href="{{asset('assets/https://templatemag.com/')}}">TemplateMag</a>
        </div>
        <a href="{{asset('assets/index.html#')}}" class="go-top">
